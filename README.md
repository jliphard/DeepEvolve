...
If you had infinite time and infinite computing resources, you could consider brute-forcing the problem, and just compare and contrast all the parameter combinations. However, in almost all real applications of neural networks, you will probably have to balance competing demands (time to market, cost, ability to continuously optimize network performance in dynamic environments) and you may - for whatever reason - have a strong interest to be able to rapidly generate good networks for diverse datasets. In that case, genetic algorithms will be useful.  
